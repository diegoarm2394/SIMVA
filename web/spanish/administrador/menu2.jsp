<html><!-- InstanceBegin template="/Templates/Template.dwt" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <link href="../css/Fuente/Fuente.css" rel='stylesheet' type='text/css'>
...
<!-- InstanceBeginEditable name="Body" -->
        ...
        <section>
    		<div id="area">
                <div id="miga">
                    ...
                    <li class="active" >Herramientas administrativas</li>
                    </ol>
                </div>
            <section class="main">
                <BR>
                        ...
                        <div class="ch-item">               
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                    <h3><br>Mantenimiento</h3>
                                    <p><a href="mantenimiento.jsp"></a></p>
                                </div>  
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="ch-item">
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                    <h3><br>Actualización</h3>
                                    <p>  <a href="actualizacion.jsp"></a></p>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="ch-item">
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                    <h3>Copia de<br>Seguridad</h3>
                                    <p> <a href="backup.jsp"> </a> </p>
                                </div>
                            </div>
                        </div>
                    </li>
    ...
    <foot>
	   <div class="pie">Versión 4.0 | COPYRIGHT   &copy;2014 SIMVA | Contáctenos: 3108549716 | E-mail: contactenos@simva.url.ph</div> 
    </foot>
