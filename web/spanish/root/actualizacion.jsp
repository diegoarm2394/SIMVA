...
<div id="area">
                    ...
                    <li><a href="menu2.jsp">Herramientas administrativas</a></li>
...
<label for="Plugins">Actualizacion:</label>
             </strong>
			 <button type="submit" class="btn btn-success3 boton">Ingresar</button>
             </strong></p>
		   	                                  
			
			<label for="Versiones">Versiones:</label>
            </strong>
			 <button type="submit" class="btn btn-success3 boton">Version</button>
		    
			</strong></p>
			
				<label for="DescargarActualizaciones">Descargar Actualizaciones :</label>
            </strong>
			 <button type="submit" class="btn btn-success3 boton">Ir Sitio WEB</button>
		    </strong></p>
            
            
            <p style="text-align: center;"><strong>
              <button type="submit" class="btn btn-success1 boton">Salir</button>
            </strong></p>
