...
<!-- InstanceBeginEditable name="Body" -->
    <body>
        <section>
                ...
                <input name="fecha" id="fechaa" type="date">

                <label for="A">Hasta:</label>
                <input name="fecha" id="fechaa" type="date">
            
              <button type="submit" class="btn btn-success boton" >Hacer</button>
              <br />
              <br />
              
                          <p style="text-align: center;"><strong>
              <button type="submit" class="btn btn-success1 boton" id="botsal2" >Salir</button>
            </strong></p>
              </div>
